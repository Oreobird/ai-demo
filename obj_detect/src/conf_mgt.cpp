...
int Conf_Mgt::refresh()
{
	...
	//id
	XML_Node node;
	nRet = _parser.get_node("object_detect/system/id", node);
	if(nRet != 0)
	{
	...
	//ip
	nRet = _parser.get_node("object_detect/system/ip", node);
	if(nRet != 0)
	{
	...
	//ip_out
	nRet = _parser.get_node("object_detect/system/ip_out", node);
	if(nRet != 0)
	{
	...
	//port
	nRet = _parser.get_node("object_detect/system/port", node);
	if(nRet != 0)
	{
	...
	//thr_num
	nRet = _parser.get_node("object_detect/system/thr_num", node);
	if(nRet != 0)
	{
	...
	//max_queue_size
	nRet = _parser.get_node("object_detect/system/max_queue_size", node);
	if(nRet != 0)
	{
	...
	//TZ
	nRet = _parser.get_node("object_detect/system/TZ", node);
	if(nRet != 0)
	{
